# Homework 2 - *chatwithfriend*

**chatwithfriend** is a Ruby on Rails blog application that allows users to send messages to each other that can only be read once.

Submitted by: **Nguyen Van Trung**

Time spent: **16** hours

URL: **https://powerful-garden-27389.herokuapp.com/**
...
![Video Walkthrough](https://i.imgur.com/i7QzgdL.gif)
